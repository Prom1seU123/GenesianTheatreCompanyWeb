...
(2, 'home/fundraising', 'Help us build our new home', 'We need your generous support. In order to make our vision a reality, we cordially invite you to join us in supporting our projects by making a donation. Every donation you make is vital and will go directly to the construction of the new theatre, which will not only be a venue for performances, but also a centre for cultural exchange and artistic cultivation. We firmly believe that with your help, we can bring more artistic enjoyment and educational resources to the community.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1aA39P8A9aNExQ2HCtUF_ycD-71Fpmpm6Vw&usqp=CAU'),
(3, 'about', 'Our new home', 'The Genesian Theatre Company is thrilled to have found a new home only one bus stop over the Anzac bridge from our current Kent St location! Plans are underway for the fit out of a brand new theatre space in the parish hall of St Joseph''s Rozelle, 2B Gordon St, to be occupied by the Genesian Theatre Company upon completion. For the immediate future we will continue to perform at 420 Kent st, but will make sure to let everybody know when we have a firm date for the move to our exciting new home! Barry Nielsen, Genesian Theatre Director, commented "We are so pleased to have found a great new venue so close by that will be easy for our many loyal patrons to attend – and we are also keen to attract locals from the Rozelle area and offer them our tradition of high quality productions at an affordable price." The new venue is just a quick 10 min hop on the bus from our current location - bus routes 500N, 502, 503, 504, 505, 506, 507 will do the job. Click map to enlarge:
Background to the move', 'https://picsum.photos/1024/480/?image=10'),
(4, 'about', 'About US','The Genesian Theatre Company celebrates our 80th year as a company in 2024! For 70 years we have been operating from our home at 420 Kent St, an historic church that has a long tradition as a theatre in the heart of the Sydney CBD. We boast among our alumni numerous household names in Australian theatre and film such as Angela Punch, Bryan Brown, Baz Luhrmann, Coral Lansbury, Judi Farr, John Bell, Peter Carroll, and Nick Enright. We''re thrilled that some of our more recent cast members such as Tom Tilley, Rowan Witt, Lib Campbell, Aaron Glenane, and Bianca Bradey have gone on to carve out their own space in the industry in the past few years. We are also just as proud of the hundreds of other talented actors, directors, stage managers, set and costume designers, lighting and sound specialists, stage and production staff who have contributed to Sydney''s unique little theatre. We are particularly proud of all our members who volunteer their time to work Front of House to help you enjoy your visit to the Genesian Theatre. Over the years the company has developed into a theatre providing a training ground for young theatre professionals and a place where those who love the theatre can meet, share, and extend their knowledge of the performing arts. The Genesian Theatre Company is one of Sydney''s most active theatre companies. In addition to six main stage productions each year we run classes, workshops, and many other activities. Membership of the company is open to all people over the age of eighteen. The building which houses the Genesian Theatre Company was originally St John''s Church, and dates from 1868. It served as both a church and a poor school until 1932 when it became the Kursaal Theatre, housing the Sydney Repertory Company. In 1938 it became the first Matthew Talbot Hostel. Since 1954 it has been the home of the Genesian Theatre Company which was formed in 1944. The Genesian Theatre Company would like to acknowledge the Gadigal of the Eora Nation, the traditional custodians of this land our theatre stands on, and pay our respects to the Elders both past and present.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR5rb3kSwAQ8kOrZoAHe8cKehACyjO5ZqssXw&usqp=CAU'),
(5, 'about', 'Our History', 'The Genesian Theatre Company came into being from a meeting of members of the Catholic Youth Organisation intent upon forming a full scale dramatic group. This meeting was held on 15th August, 1944. Named for St Genesius, Patron Saint of Actors, The Genesian Theatre Company has developed into a strong theatre company over the years. Monday 29th January 1945 was the Opening Night of the Genesians first production. This was The Comedian by Henri Ghéon, a drama about St. Genesius, patron saint of actors reputedly martyred by Diocletian in the year 303 A.D. and from whom the name of our theatre is derived. Between 1945 and 1954 the Genesians used a variety of venues for their productions. Some of the theatres used were the Australian Hall (later Rivoli Theatre), the Sydney Radio Theatre, the Conservatorium, Manresa Hall, and the Capitol Theatre. Our present theatre was originally a church dedicated to St John the Evangelist, opened on Sunday 4th October 1868.', 'https://images.squarespace-cdn.com/content/v1/591b3e9ebebafbf97085a3af/1502934854586-RLLRGACK16KLCYGMJ9QU/image-asset.png'),
(6, 'about/work', 'Become a member', 'Being a member of the Genesian Theatre Company is like being part of large family of like-minded theatre people. If you''d like to experience being a member of a theatre company, we''d welcome you to join us! You don''t need to be experienced, we can provide training and can cater to different levels of involvement. We welcome actors, directors, stage managers, designers (Set, Costume, Lighting, Sound), the publicity people who bring in the crowds, and the admin people who keep the theatre running. There is a one-year probationary period for intending members during which time you have all the privileges of membership except voting rights and access to grants for theatre study. The fee for probationary membership is $33 (GST included). All members are required to perform Front of House duty at least once for every Genesian production - working behind the bar selling refreshments and assisting patrons to their seats. This usually works out to between 6 or 8 times per year. Our next meeting for prospective new members will be held soon. The meeting should last about an hour. It gives you a chance to meet some existing members and to ask questions about the theatre, and you will be able to join the Genesian Theatre at the conclusion of the meeting.', 'https://t3.ftcdn.net/jpg/05/03/75/06/360_F_503750620_MCeQsrUqic4BPihZQqWrckhLJYZIarZO.jpg'),
